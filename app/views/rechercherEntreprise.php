...
<body>
    <div class="mainContainer">
        ...
        <div class="formContainer">
            ...
            <form type="GET" action="rechercherEntreprise.php">
                ...
                <span>
                    Adresse site web : <input type="text" name="nom" >
                </span>
                <span>
                    IBAN : <input type="text" name="nom" >
                </span>
                <span>
                    Type d'entreprise :
                    <select name="code">
        ...
        <div class="responseContainer">
            <div class="tableContainer">
                <div class="sectionTitleContainer">
                        <div></div>    
                        <h2 class="sectionTitle">.. entreprise trouvés</h2>
                        <div></div>
                    </div> 
                <table>
                    <thead>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>Où</td>
                            <td>type</td>
                            <td>consultation antérieuraaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa</td>
                            <td>voir plus</td>
                        </tr>
                    </tbody>
                </table>
