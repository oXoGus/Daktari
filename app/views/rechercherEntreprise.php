...
<body>
    <div class="mainContainer">
        <div class="navBar" style="height:70px; margin-top: 10px">
            <a href="nouvelleentreprise.php">nouvelle Consultation</a>
            ...
            <div class="menuDeroulantContainer">
                ...
                <div class="menuDeroulant">
                    ...
                    <a class="menuItem" href="nouvelleConsultation.php">une consultation</a>
            ...
            <div class="menuDeroulantContainer">
                ...
                <div class="menuDeroulant">
                    ...
                    <a class="menuItem" href="nouveauParticulier.php">un particulier</a>
                    <a class="menuItem" href="rechercherConsultation.php">une consultation</a>
