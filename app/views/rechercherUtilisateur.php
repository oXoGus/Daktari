    ...
    <body>
        <div class="mainContainer">
            ...
            <div class="formContainer">
                ...
                <form type="GET" action="rechercherUtilisateur.php">
            ...
            <div class="formContainer">
                <div class="sectionTitleContainer">
                    ...
                    <?php
                        ...
                        $countRU = $resRU->rowCount();
                        echo $countRU." utilisateurs trouvés\n";
                        echo "</h2>";
                    ?>
                    <div></div>
                </div>
                <table>
                    ...
                    <?php
                        ...
                        foreach ($lignesRU as $ligneRU) {
                            echo"<tr><th>".$ligneRU->username ."</th><td><a href='modifierUtilisateur.php?id=".$ligneRU->id."'>Voir/Modifier</a></td></tr>";
                        }
                        ?>
                    </tbody>
                </table>
