        ...
        <div class="mainContainer">
            ...
            <div class="formContainer">
                ...
                <form type="GET" action="rechercherAnimal.php">
                    ...
                    <span>Nom : <input type="text" name="nom">
                    </span>
                    <span>Espece : <input type="text" name="espece">
                    </span>
                    <span>
                        Race : <input type="text" name="espece">
                    </span>
                    <span>
                        Genre : 
                    ...
                    <span>Castré : 
                        <input type="radio" value="O" name="castre">
                        Oui
                        <input type="radio" value="N" name="castre">
                        Non
                    </span>
                    <span>
            ...
            <div class="formContainer">
                <div class="sectionTitleContainer">
                    ...
                    <?php
                        ...
                        $count = $res->rowCount();
                        echo $count." utilisateurs trouvés\n";
                        echo "</h2>";?>
                    <div></div>
                </div>
                <table>
                    ...
                    <tbody>
                        ...
                        foreach ($lignes as $ligne) {
                            echo"<tr><th>".$ligne->responsable ."</th><td>".$ligne->nom ."</td><td>".$ligne->espece ."</td><td>".$ligne->race ."</td><td>".$ligne->genre."</td><td>".$ligne->taille."</td><td><a href='modifierAnimal.php?id=".$ligne->id."'>Voir/Modifier</a></td></tr>";
                        }
                        ?>
                    </tbody>
                </table>
