...
//on essaye de se connecter à la base de données
    ...
    //On récupère le hash
    $sql ="SELECT a.id as id, b.nom as responsable, a.nom as nom, a.espece as espece, a.race as race, a.genre as genre, a.taille as taille FROM animaux a, responsable b $req";
