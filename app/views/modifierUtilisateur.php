        ...
        <div class="formContainer">
            ...
            <div class="sectionTitleContainer">
                ...
                <div class="spanContainer">
                    ...
                    <span>Nom d'utilisateur : <input type="text" name="usernamemodif" value="<?= htmlspecialchars($usernameMU[0]->username ?? '');?>"></span>
                </div>
                ...
                <div style="display: none;" class="doubleVerifContainer" id="doubleVerifContainer">
                    <div>
                        <h1>ATTENTION !</h1>
                        <p>êtes vous bien sûr de vouloir supprimer cet utilisateur ?</p>
                        <div>
                            <a href="DELETEUtilisateur.php?id=<?= $_GET['id']?>">Oui</a>
